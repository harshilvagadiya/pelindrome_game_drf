...
once the leangth of the string is 6, it should return whether the string is pelindrome or not and List of Games API this api should list all game IDS created in system
